...
public class OfflineGameInfiniteModeModule : MonoBehaviour, IGameModule {
    ...
    public void OnFinish () {
        GameObject.FindObjectOfType<AssetLoader> ().StartCoroutine (AssetBundleManager.RequestScene (true, false, "ClientOffline", null, (onFinish) => { }));
